...
5. Select these settings: <br>![alt text](img/JLC2.png)
   You can choose any surface finish you like, or none at all, according to your preference!
6. In the order summary on the right, look at the shipping. Open the shipping selection menu by clicking on the drop down arrow:<br> ![alt text](img/JLC1.png)
...
8. You may get a popup like this:<br> ![alt text](img/JLC3.png)
